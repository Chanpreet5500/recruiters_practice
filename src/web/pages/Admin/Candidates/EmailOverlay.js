...
import { StyledLable, StyledSelectBox } from '../../../styledComponent/StyledComponents';
  ...
  return (
    <React.Fragment>
      ...
      >
        <StyledSelectBox>
          <Box >
            <StyledLable varient="label"><Text tid="jobs-text" /></StyledLable>
            <SingleSelect
              label={""}
              placeholder={"Jobs"}
        ...
        <Box>
          <Box>
            <Box>
            <StyledLable varient="label"><Text tid="add-invite-text" /></StyledLable>
              <Box>
                <Textarea
                  label={""}
                  type={"text"}
