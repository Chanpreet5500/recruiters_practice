...
import {
  ...
  ERROR_INVALID_CONFIRM_NEW_PASSWORD,
  ERROR_PASSWORD_MISMATCH,
  COMPANYNAME_ERROR_MESSAGE,
  COMPANYNUMBER_ERROR_MESSAGE,
  STREETADDRESS_ERROR_MESSAGE,
  CITY_ERROR_MESSAGE,
  COUNTRY_ERROR_MESSAGE,
  ZIPCODE_ERROR_MESSAGE,
  PROFESSION_ERROR_MESSAGE,
  EDUCATION_ERROR_MESSAGE,
...
const Profile = (props) => {
  ...
  const updateProfile = useStoreActions(
    (actions) => actions.admin.updateProfile
  );
    ...
    <React.Fragment>
      ...
      <HeadingBox>
        ...
        <Box>
          <Button
            type={"top-button"}
            extraClasses={`float-right mt-3 ${
              disableButton ? "loaderBtn disable" : ""
            }`}
            onClick={() => (disableButton ? "" : saveProfile())}
            label={"Save Changes"}
        ...
        <ShortContainer>
          ...
          <InputContainer>
            <Input
              ...
              error={zipCodeError}
              placeholder={"Zipcode"}
              errorMessage={ZIPCODE_ERROR_MESSAGE}
            />
          </InputContainer>
        </ShortContainer>
      </MainContainer>
